...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='YOLOv13n IP102_pruned_30 训练脚本')
    parser.add_argument('--data', type=str, default='configs/data_ip102_pruned_30.yaml', help='数据集配置文件')
    parser.add_argument('--epochs', type=int, default=60, help='总训练轮数 (20+50)')
    parser.add_argument('--batch', type=int, default=50, help='批次大小')
    parser.add_argument('--imgsz', type=int, default=512, help='图像尺寸')
    parser.add_argument('--device', type=str, default='0', help='训练设备')
    # parser.add_argument('--freeze', type=int, default=40, help='冻结层数 (0=不解冻)')
    parser.add_argument('--project', type=str, default='runs/ip102', help='输出目录')
    parser.add_argument('--name', type=str, default='yolo13n_ip102_atten_pruned', help='实验名称')
